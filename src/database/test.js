...
Database.then(async (db)=>{
    ...
    //e traser junto os dados do professor
    ...
    // o horario que a pessoa trabalha, por exemplo e das 8h ate as 18h
    //o horario do tim_from (8h) precisa ser menor ou igual ao horario solicitado
